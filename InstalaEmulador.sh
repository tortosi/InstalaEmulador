...
repos=$HOME/Repos
rep_tricore="-b 3.3.5 git://github.com/TrinityCore/TrinityCore.git"
db_tdb_335=https://github.com/TrinityCore/TrinityCore/releases/download/TDB335.20091/TDB_full_world_335.20091_2020_09_15.7z
# OBTENGO NOMBRE DE ACHIVO COMPRIMIDO DE BASE DE DATOS
arch_comp=$(basename "$db_tdb_335")
# OBTENGO NOMBRE DE ACHIVO SQL
arch_sql=${arch_comp%.*}.sql
...
####################################################################
		...
		cp $HOME/Repos/TDB-335/$arch_sql $server_tricore/bin
		dialog --title "INFORMACIÓN" \
		--backtitle "https://catlinux.es" \
